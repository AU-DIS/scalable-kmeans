...
class kmeans_class:
    ...
    def execute_clustering(self):
        ...
        total_new_lemma_dist_count = total_lloyd_dist_count - ((elkan_count + new_lemma_count) * datasize)
...
def kmeans_elkan_new_lemma_manual(x, k, max_iter=100, initialCentroids=None, kmeans_threshold=0):
